...
{/* Navigation */}{" "}
  ...
  <div className="bg-red-100 rounded-lg shadow-md overflow-hidden max-w-md mx-auto my-16">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-start">
          <h3 className="text-lg font-semibold text-gray-800">10 AM - 8 PM</h3>
          <p className="flex items-center text-lg font-bold text-red-600"></p>
        </div>

        <a
          href="https:/wa.me/0570043020"
          target="-blank"
          className="flex justify-between items-start"
        >
          <h3 className="text-lg font-semibold text-red-600 hover:text-red-800">
            {" "}
            <Link2Icon size={18} className="inline" /> Contact
          </h3>
        </a>

        <div className="flex justify-between items-start">
          <h3 className="text-lg font-semibold text-red-600"></h3>
        </div>
