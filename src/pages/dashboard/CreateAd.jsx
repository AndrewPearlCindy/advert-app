...
const CreateAd = () => {
  ...
  return (
      <section className="bg-white">
        <div className="w-full  h-auto max-w-2xl mx-auto mt-16 mb-16 p-6 bg-white rounded-lg shadow-lg shadow-red-500">

        <h2 className="text-2xl font-bold mb-8 text-center bg-red-500 rounded-lg text-white">
          <Utensils className="inline mr-2 text-white" size={24} /> Create an
          Ad
        </h2>
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <label className="block text-gray-700 font-medium mb-2">
              <Tag className="inline mr-2 text-red-500" size={18} /> Food
              Category
            </label>
            <select
              name="category"
